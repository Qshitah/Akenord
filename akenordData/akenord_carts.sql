...
CREATE TABLE `carts` (
  ...
  CONSTRAINT `fk_carts_users` FOREIGN KEY (`username_user`) REFERENCES `users` (`username`)
...
INSERT INTO `carts` VALUES ('marouan','2023-10-22 17:14:47'),('said','2023-10-18 11:09:07');
