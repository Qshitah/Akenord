...
CREATE TABLE `tokens` (
  ...
  `type` enum('password_reset','email_verification') COLLATE utf8mb4_general_ci NOT NULL,
  `expiration_date` datetime NOT NULL,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `fk_tokens_users` (`username_user`),
  CONSTRAINT `fk_tokens_users` FOREIGN KEY (`username_user`) REFERENCES `users` (`username`)
