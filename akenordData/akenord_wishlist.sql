...
CREATE TABLE `wishlist` (
  ...
  CONSTRAINT `fk_wishlist_users` FOREIGN KEY (`username_user`) REFERENCES `users` (`username`)
...
INSERT INTO `wishlist` VALUES ('marouan','2023-10-16 07:41:45'),('said','2023-10-15 09:21:52');
