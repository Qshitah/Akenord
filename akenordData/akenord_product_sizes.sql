...
CREATE TABLE `product_sizes` (
  ...
  KEY `fk_productSizes_sizes` (`size_id`),
  CONSTRAINT `fk_productSizes_products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  CONSTRAINT `fk_productSizes_sizes` FOREIGN KEY (`size_id`) REFERENCES `sizes` (`id`)
...
INSERT INTO `product_sizes` VALUES (1,1),(2,1),(1,2),(8,2),(9,2),(13,2),(2,3),(8,3),(3,4),(9,4),(13,4);
