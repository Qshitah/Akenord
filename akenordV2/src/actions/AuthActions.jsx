...
export const loginUser = (userData) => {
  ...
  return async (dispatch) => {
    try {
      ...
      const response = await axios.post("https://akenord.ma:8443/api/auth/login", userData);
...
export const register = (userData) => {
    ...
    return async (dispatch) => {
        try {
          ...
          // Make an API request to your backend for authentication
          const response = await axios.post("https://akenord.ma:8443/api/auth/register", userData);
